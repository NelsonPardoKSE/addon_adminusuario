		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Admin. Usuario",
									"targetURL": "#comaddonadminusuario-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaddonadminusuario-display": {
								"semanticObject": "comaddonadminusuario",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.addonadminusuario",
									"url": sap.ui.require.toUrl("com/addonadminusuario")
								}
							}
						}
					}
